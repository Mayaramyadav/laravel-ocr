...
Configure test driver in `phpunit.xml` under `SMART_OCR_DRIVER=tesseract`. Laravel 12+ requires PHP 8.2+ and enables strict mode by default (`failOnWarning`, `beStrictAboutTestsThatDoNotTestAnything`).
